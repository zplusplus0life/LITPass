...
import {store as AdminSaveBooks} from '@/routes/admin/books';
...
export default function Create() {
    ...
    const submit = (e :  React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        post(AdminSaveBooks().url);
    };


    return(
        <AuthLayout
        header={<h2 className="font-semibold text-xl text-gray-800">Add New Book</h2>}
        >

        <Head title="Admin - Add Book" />
